      ...
      <div className="mx-auto max-w-lg px-4 py-6">
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl bg-black">
            ...
            {isProcessing && (
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-black/70 backdrop-blur-sm">
                <div className="spinner !h-8 !w-8 text-emerald-400" />
                <span className="text-sm font-medium text-emerald-300 animate-pulse">
                  {statusText}
                </span>
              </div>
            )}
        ...
        {status === "idle" && (
          <button
            ...
            className="pulse-glow w-full rounded-2xl bg-gradient-to-r from-emerald-600 to-cyan-600 px-6 py-4 text-lg font-bold text-white shadow-xl shadow-emerald-500/20 transition-all duration-300 hover:scale-[1.02] hover:shadow-emerald-500/40 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none"
